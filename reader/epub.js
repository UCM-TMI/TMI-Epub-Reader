...
EPUBJS.Book.prototype.open = function(bookPath, forceReload){
	...
	if(true || this.settings.contained || this.isContained(bookPath)){
...
EPUBJS.Book.prototype.unarchive = function(bookPath){
	...
	return this.zip.openBinary(bookPath);
};
...
EPUBJS.Unarchiver.prototype.openBinary = function(binary, callback){
  var deferred = new RSVP.defer();

  return EPUBJS.core.request(binary, "epub").then(function(data){
    this.zip = new JSZip(data);
  }.bind(this));
};
